...
func main() {
	urls := []string{
		"https://images.pexels.com/photos/8247303/pexels-photo-8247303.jpeg",
		"https://images.pexels.com/photos/38241682/pexels-photo-38241682.jpeg",
		//"https://images.pexels.com/photos/38241682/pexels-photo-3824167dd2.jpeg",
	}

	err := ConcurrentDownloader(urls, "./images/downloads", 3)
	if err != nil {
		fmt.Println(err)
		return
	}
